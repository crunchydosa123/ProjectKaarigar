...
Example: *“Make this video shorter and add retro music”* → executed instantly.
...
### Backend
- **Python + Flask** → Lightweight, AI-ready API  
- **FFmpeg** → Video/audio manipulation via natural prompts  

### Cloud Generative AI/ML
- **Gemini (2.5 Flash & Pro)** → Conversational onboarding, content generation, analytics  
- **Imagen & Veo 3** → AI-generated product backdrops + promo videos  
- **Vertex AI AutoML** → Pricing optimization  
...
- CI/CD pipelines → fast, reliable updates  
- No server management required  

### Scalability
- **Compute**: Auto-scales from 0 → 1000s requests (Cloud Run, Functions)  
